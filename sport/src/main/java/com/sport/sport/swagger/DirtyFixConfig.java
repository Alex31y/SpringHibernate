package com.sport.sport.swagger;
...
public class DirtyFixConfig {
    ...
    //Failed to start bean 'documentationPluginsBootstrapper' fix https://github.com/springfox/springfox/issues/3462
    @Bean
